...
{: #conformance-requirement-5-1}
    1. §deqm-01: Composite Measures **SHALL** conform to the CQMCompositeMeasure profile §
    2. §deqm-02: Composite Measures **SHALL** specify a composite measure scoring method §
