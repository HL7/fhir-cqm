...
* See the capability statements defined in the [Data Exchange for Quality Measures](http://hl7.org/fhir/uv/deqm) implementation guide for the Submitting and Receiving System roles.
...
* Submitting System - This would be either a hospital, physician practice, or any organization that wants to submit the relevant quality measure data to a receiving system
* Knowledge Repository - This would be a FHIR server that has the quality measures loaded and is the source of truth for those quality measures and can provide the required data elements for each measure
* Terminology Service - This can be any valid FHIR terminology service that has the appropriate ValueSets used in the quality measures and can provide the expansion of those ValueSets
* Receiving System - This would be the system that will receive all of the relevant clinical data for a given quality measure and be able to perform the evaluation of that measure
