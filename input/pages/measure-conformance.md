...
In addition to the measure scoring, measures generally fall into two categories, subject-based (previously referred to as patient based), and non-subject-based (previously most often referred to episode of care or encounter based).
